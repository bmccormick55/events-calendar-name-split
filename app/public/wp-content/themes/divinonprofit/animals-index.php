    ...
    <div id="main-content">
        ...
        <div class="interior-header">
            <div class="et_pb_row  et_pb_bg_layout_dark et_pb_text_align_center">
                ...
                <?php if (is_tax()): ?>
                    <h1>
                        <?php echo sprintf(esc_html__('Find %s for adoption', 'divi-nonprofit'), single_term_title("", false)); ?>
                    </h1>
                <?php elseif (is_search()): ?>
                    <h1><?php printf(esc_html__('Search Results for "%s"', 'divi-nonprofit'), '<span>' . get_search_query() . '</span>'); ?></h1>
                <?php elseif (is_archive()): ?>
                    <h1><?php esc_html_e('Find Pets for Adoption', 'divi-nonprofit'); ?></h1>
                <?php endif; ?>
                ...
                <form role="search" method="get" id="divinonprofit_searchform" action="<?php bloginfo('url'); ?>">
                    <input type="text" value="<?php if (is_search()) {
                        ...
                        echo esc_html__('Enter an animal name here...', 'divi-nonprofit');
                    } ?>" onfocus="this.value='';" name="s" id="s"/>
                    <input type="hidden" name="post_type" value="animal"/>
                    <input type="submit" id="searchsubmit"
                           value="<?php esc_html_e('Find a pet', 'divi-nonprofit'); ?>"/>
                </form>
        ...
        <div class="container">
            <div id="content-area" class="clearfix">
                ...
                <?php get_sidebar('archive-animal'); ?>
