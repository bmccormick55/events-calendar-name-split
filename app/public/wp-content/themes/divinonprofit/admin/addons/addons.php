...
// define('AGS_THEME_ADDONS_URL', 'https://divi.space/wp-content/uploads/product-addons/divi-ecommerce.json');
...
if (defined('AGS_THEME_ADDONS_URL')) {
    ...
    add_action('admin_menu', function() {
        add_menu_page( 'Addons Test', 'Addons Test', 'manage_options', 'ags-product-addons', [ 'AGS_Theme_Addons', 'outputList' ] );
    });
    */
